...
ajoutmedicament::ajoutmedicament(pharmacien * pharmacienUi, ClientTCP * client, QWidget *parent)
	: QObject(parent)
{
...
void ajoutmedicament::ajoutMedoc()
{
	...
	//Ui::pharmacienClass * ui = pharmacien->getUI();
	//qDebug() << "test";
...
void ajoutmedicament::recuperation()
{
	...
	qDebug() << "test";
	//client->envoiMessage(newMedicament);
}
