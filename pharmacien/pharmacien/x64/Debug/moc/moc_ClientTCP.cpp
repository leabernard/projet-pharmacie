...
QT_MOC_LITERAL(1, 10, 17), // "socketIsConnected"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "messageRecu"
QT_MOC_LITERAL(4, 41, 15) // "socketConnected"

    },
    "ClientTCP\0socketIsConnected\0\0messageRecu\0"
    "socketConnected"
};
...
void ClientTCP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->socketIsConnected(); break;
        case 1: _t->messageRecu(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientTCP::socketIsConnected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientTCP::socketIsConnected()
{
