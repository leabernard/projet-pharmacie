...
pharmacien::pharmacien(ClientTCP * client, QWidget *parent)
	: QMainWindow(parent)
{
...
void pharmacien::medicament() {
	...
	//QString queryString = "SELECT nom FROM medicament";
	...
	//client->envoiMessage(queryString);
...
void pharmacien::patient() {
	...
	//client->envoiMessage(newOrdonnance);
...
void pharmacien::commande()
{
	...
	//client->envoiMessage(SQLIDMedicament);
	//Envoir BDD
