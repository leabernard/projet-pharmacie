...
void bilanCommande::visual()
{
	...
	model->setQuery("select medicament.nom, commande.quantite, commande.idordonnance, commande.idcommande, commande.Nom, ordonnance.date from medicament, commande,ordonnance where medicament.idmedicament = commande.idmedicament");
	...
	model->setHeaderData(3, Qt::Horizontal, tr("Id commande"));
