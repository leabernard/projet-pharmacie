...
QT_MOC_LITERAL(1, 7, 10), // "onDataRead"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4), // "code"
QT_MOC_LITERAL(4, 24, 14) // "receiveMessage"

    },
    "Reader\0onDataRead\0\0code\0receiveMessage"
};
...
void Reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onDataRead((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Reader::onDataRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Reader::onDataRead(QString _t1)
{
