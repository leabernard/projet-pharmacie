...
QT_MOC_LITERAL(1, 8, 15), // "surMedicamentLu"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4) // "code"

    },
    "Scanner\0surMedicamentLu\0\0code"
};
...
void Scanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->surMedicamentLu((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
